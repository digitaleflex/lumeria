    ...
    <div className="min-h-screen font-['Outfit']">
        ...
        <div className="container mx-auto px-4 relative z-10 flex justify-start">
          ...
          >
            <h1 className="text-[3.5rem] leading-[1] md:text-8xl font-['Playfair_Display'] md:leading-tight">
              ...
              <span className="text-violet-600 italic">Skin</span>
              <br />
              <span className="text-gray-900">Your </span>
              <span className="text-violet-300 italic">Glow</span>
            </h1>

            <p className="text-xl text-gray-800 leading-relaxed font-light max-w-lg">
              Elevate your routine with our
              <span className="font-medium text-gray-900 mx-1">premium skincare collection</span>
              designed for ultimate radiance.
            </p>
        ...
        <div className="max-w-7xl mx-auto flex gap-4 overflow-x-auto pb-4 no-scrollbar">
          <Link to="/category/sunscreen" className="flex-shrink-0 group cursor-pointer block">
            <div className="w-48 h-20 bg-orange-50 dark:bg-orange-900/20 rounded-2xl flex items-center px-4 gap-3 border border-orange-100 dark:border-orange-900/30 group-hover:scale-105 transition">
              ...
              <div>
                <p className="text-xs font-bold text-gray-900 dark:text-gray-100">Sunscreen</p>
          ...
          <Link to="/category/moisturizer" className="flex-shrink-0 group cursor-pointer block">
            <div className="w-48 h-20 bg-blue-50 dark:bg-blue-900/20 rounded-2xl flex items-center px-4 gap-3 border border-blue-100 dark:border-blue-900/30 group-hover:scale-105 transition">
              ...
              <div>
                <p className="text-xs font-bold text-gray-900 dark:text-gray-100">Moisturizer</p>
          ...
          <Link to="/category/skincare" className="flex-shrink-0 group cursor-pointer border-2 border-violet-600/30 rounded-2xl block">
            <div className="w-48 h-20 bg-violet-50 dark:bg-violet-900/20 rounded-2xl flex items-center px-4 gap-3 border border-violet-100 dark:border-violet-900/30 group-hover:scale-105 transition">
              ...
              <div>
                <p className="text-xs font-bold text-violet-600">Serums</p>
                <p className="text-[10px] text-gray-500">Bestselling</p>
              </div>
            </div>
          </Link>
          <Link to="/category/makeup" className="flex-shrink-0 group cursor-pointer block">
            <div className="w-48 h-20 bg-pink-50 dark:bg-pink-900/20 rounded-2xl flex items-center px-4 gap-3 border border-pink-100 dark:border-pink-900/30 group-hover:scale-105 transition">
              ...
              <div>
                <p className="text-xs font-bold text-gray-900 dark:text-gray-100">Lip Care</p>
          ...
          <Link to="/shop" className="flex-shrink-0 group cursor-pointer block">
            <div className="w-48 h-20 bg-gray-50 dark:bg-gray-800 rounded-2xl flex items-center px-4 gap-3 border border-gray-100 dark:border-gray-700 group-hover:scale-105 transition">
              ...
              <div>
                <p className="text-xs font-bold text-gray-900 dark:text-gray-100">Shop All</p>
                <p className="text-[10px] text-gray-500">View Catalog</p>
              </div>
            </div>
          </Link>
        </div>
      ...
      <div className="bg-violet-600/5 py-6 overflow-hidden whitespace-nowrap border-y border-violet-600/10">
        <div className="flex gap-12 animate-marquee min-w-max">
          <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-violet-600"><Flower2 className="w-4 h-4" /> Formulated for all skin tones</span>
          <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-violet-600"><ShieldCheck className="w-4 h-4" /> Dermatologist Tested</span>
          <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-violet-600"><Leaf className="w-4 h-4" /> 100% Vegan &amp; Organic</span>
          <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-violet-600"><FlaskConical className="w-4 h-4" /> Paraben &amp; Sulfate Free</span>
          ...
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-4xl font-['Playfair_Display']">
                Shop Our <span className="italic text-violet-600 underline decoration-violet-300 decoration-wavy underline-offset-8">Glow Heroes</span>
              </h2>
              <p className="mt-4 text-gray-500">Our community's most-loved essentials for radiant skin.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="relative overflow-hidden rounded-2xl aspect-[16/9] bg-gradient-to-r from-violet-500 to-purple-600">
              ...
              <div className="absolute inset-0 flex flex-col justify-center p-8">
                <span className="text-white/80 text-sm font-medium mb-2">Limited Time</span>
                <h3 className="text-3xl font-bold text-white mb-4">50% OFF</h3>
                <p className="text-white/90 mb-4">On selected skincare bundles</p>
                <Link to="/shop">
            ...
            <div className="relative overflow-hidden rounded-2xl aspect-[16/9] bg-gradient-to-r from-rose-400 to-pink-500">
              ...
              />
              <div className="absolute inset-0 flex flex-col justify-center p-8">
                <span className="text-white/80 text-sm font-medium mb-2">New In</span>
                <h3 className="text-3xl font-bold text-white mb-4">Glow Routine</h3>
                <p className="text-white/90 mb-4">Complete skincare kits</p>
      ...
      <section className="py-24 px-6 bg-violet-300/10 dark:bg-gray-800/30 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-5xl font-['Playfair_Display'] mb-6 text-gray-900">
            Shop by <span className="text-violet-600 italic">Category</span>
          </h2>
          <p className="text-gray-600 dark:text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
            Find the perfect products for your skin needs. Our carefully curated collections are designed to address your unique skin concerns.
          </p>
      ...
      < section className="py-16 bg-violet-50" >
        <div className="container mx-auto px-4">
          <SectionHeader
            title="The Glow Edit"
            subtitle="Our community's favorite picks this month"
            action={{ label: 'View All', href: '/shop?sort=trending' }}
          />
          {isLoading ? (
      ...
      <section className="py-24 px-6 md:px-4">
        <div className="container mx-auto max-w-7xl relative overflow-hidden flex flex-col md:flex-row items-center gap-12 bg-gradient-to-r from-gray-900 to-violet-600 p-12 md:p-16 rounded-[40px] text-white">
          ...
          <div className="md:w-1/2 relative z-10 text-center md:text-left">
            <span className="bg-white/20 px-4 py-1 rounded-full text-xs font-bold tracking-widest mb-6 inline-block uppercase">New Feature</span>
            <h2 className="text-4xl md:text-5xl font-['Playfair_Display'] mb-6">AI Skin Analyzer</h2>
            <p className="text-white/80 text-base md:text-lg mb-8 max-w-md mx-auto md:mx-0">Upload a selfie and get a personalized skincare routine designed specifically for your skin's unique needs. Powered by dermatological science.</p>
          ...
          <div className="hidden md:flex md:w-1/2 justify-center z-10 w-full mt-8 md:mt-0">
            <div className="relative w-64 h-80 md:w-72 md:h-96 bg-white/10 rounded-[30px] border border-white/20 flex items-center justify-center backdrop-blur-md overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 w-full px-6 space-y-4">
                ...
                <p className="text-center font-bold tracking-widest uppercase text-xs">Scanning Skin Texture...</p>
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-white/20 backdrop-blur-md p-2 rounded-lg text-xs font-medium text-center shadow-lg">Hydration: 84%</div>
                  <div className="bg-white/20 backdrop-blur-md p-2 rounded-lg text-xs font-medium text-center shadow-lg">Sensitivity: Low</div>
                </div>
              </div>
            </div>
          </div>
      ...
      < section className="py-16 bg-white" >
        <div className="container mx-auto px-4">
          <SectionHeader
            title="More to Love"
            subtitle="Handpicked products for your skincare routine"
